...
exports.BASE_REWARD = 256 * exports.COIN;
...
exports.getReward = function getReward(height, interval) {
  ...
  if (height == 0)
	{
		return 1 * exports.COIN;
	}

	if (height == 1)
	{
		return 200000 * exports.COIN;
	}

  let Subsidy = 256 * exports.COIN;
  let minimumSubsidy = 8.0 * exports.COIN;

	// Subsidy is reduced by 6% every 10080 blocks, which will occur approximately every 1 week
  let exponent = (height / 10080);
  let i;
