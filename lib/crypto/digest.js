...
const throestl = require('node-throestl-hash');
...
/**
 * Hash with throestl (OP_HASH256).
 * @param {Buffer} data
 * @returns {Buffer}
 */

exports.throestl = function hashthroestl(data) {
  return throestl.digest(data);
};
...
if (native) {
  ...
  exports.throestl = digest.throestl;
}
